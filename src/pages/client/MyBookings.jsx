...
const MyBookings = () => {
  ...
  const viewBookingDetails = (bookingId) => {
    ...
    if (booking) {
      navigate(`/venues/${booking.venue_id}`);
    } else {
  ...
  const contactVenue = (bookingId) => {
    ...
    try {
      ...
      toast.success(`💬 Chat opened for ${booking.venue_name || "venue"} support!`);
    } catch (error) {
    ...
    <div className="my-bookings-page">
      <div className="my-bookings-container">
        <div className="my-bookings-header">
          <h1 className="my-bookings-title">My Event Bookings</h1>
          <p className="my-bookings-subtitle">Track and manage all your venue bookings</p>
        </div>
        ...
        {bookings.length === 0 ? (
          <div className="my-bookings-empty">
            ...
            <p className="empty-text">Start planning your next amazing event!</p>
            <button
              onClick={() => navigate("/venues")}
              className="empty-action"
            >
              <Search size={20} />
              Browse Amazing Venues
            </button>
          </div>
        ) : (
          <>
              ...
              <div key={booking.id} className="booking-card">
                <div className="booking-header">
                  ...
                  <div>
                    ...
                    <p className="booking-price">KES {booking.total_cost.toLocaleString()}</p>
                  </div>
                </div>
