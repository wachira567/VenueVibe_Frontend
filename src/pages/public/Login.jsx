...
const Login = () => {
  ...
  const from = location.state?.from || "/venues"; // Redirect back to venue or venues page
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // No toast notification for login errors
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="login-image-overlay">
            <div className="login-image-content">
              ...
              <p className="login-image-quote">
                "The only platform where I found my dream wedding venue in under
                10 minutes."
              </p>
            </div>
          </div>
        ...
        <div className="login-form-section">
          <div className="login-form-container">
            ...
            <p className="login-form-subtitle">
              Access your bookings and saved venues.
            </p>
            ...
            <form onSubmit={handleSubmit} className="login-form">
              ...
              <button disabled={loading} className="login-submit-button">
