...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // No toast notification for registration errors
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="register-image-section">
          ...
          <div className="register-image-overlay">
            <div className="register-image-content">
              ...
              <p className="register-image-quote">
                "Find your perfect venue and create unforgettable memories."
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="register-form-section">
          <div className="register-form-container">
            ...
            <form onSubmit={handleSubmit} className="register-form">
              ...
              <button disabled={loading} className="register-submit-button">
                {loading ? "Creating account..." : "Create Account"}{" "}
                <ArrowRight className="register-submit-icon" />
              </button>
            </form>
