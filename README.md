...
A modern, responsive React-based frontend application for the VenueVibe venue booking platform. This application provides an intuitive user interface for discovering, booking, and managing event venues.

## Project Overview

VenueVibe is a comprehensive venue booking platform that connects event organizers with venue providers. The frontend application handles user interactions, authentication, venue browsing, booking management, and administrative functions.
...
### User Features
- **Venue Discovery:** Browse and search venues by location, category, and capacity
- **User Authentication:** Secure login and registration with email/password and Google OAuth
- **Venue Booking:** Real-time availability checking and booking with multi-day support
- **Saved Venues:** Save favorite venues for quick access
- **Booking Management:** View booking history, download invoices, and track booking status
